...
|----------------|:---------:|----------------:|
| /              | Авторизация | Cтраница авторизации |
| /login         |       текст |                      |
| /profile       |             | Cтраница, которая отображает любую информацию об авторизованном пользователе. Должна быть закрыта без авторизации |
| /info          |             | Cтраница с любой однородной информацией|
